                ...
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-lg-10">
                        ...
                        <div class="box-shadow-content">
                            ...
                            <span class="d-block mb-3 text-white" data-aos="fade-up">{{$time}}<span                                class="mx-2 text-primary">&bullet;</span>by Nasibu Mahinya<br> &bullet;Science</span>
                                <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">Nm Blog</h1>
                                <!-- <p class="" data-aos="fade-up">Science</p> -->
                            </div>
